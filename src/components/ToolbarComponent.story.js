...
storiesOf('ToolbarComponent', module).add('All Messages Selected', () => {
  return (
    <ToolbarComponent messages={data} selectedMessageCount={data.length} />
  );
});
storiesOf('ToolbarComponent', module).add('Some Messages Selected', () => {
  return <ToolbarComponent messages={data} selectedMessageCount={1} />;
});
storiesOf('ToolbarComponent', module).add('No Messages Selected', () => {
  return <ToolbarComponent messages={data} selectedMessageCount={0} />;
});
