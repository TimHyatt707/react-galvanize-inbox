...
storiesOf('MessagesComponent', module).add('Empty Select MessageIds', () => {
  return <MessagesComponent messages={data} selectedMessageIds={[]} />;
});

storiesOf('MessagesComponent', module).add('Non-empty MessageIds', () => {
  return <MessagesComponent messages={data} selectedMessageIds={[2, 4]} />;
});
